...
app.post('/upload-csv', async (req, res) => {
    const filePath = "C:/Users/USUARIO/Desktop/csv_postgres_Ronald/uploads/countries.csv"; // Ruta del archivo CSV
    const results = [];
...
// ENDPOINT 2: Exportar datos de la tabla countries a un archivo CSV
